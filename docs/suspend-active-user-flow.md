...
SPA -> BE : <font color=#1e1e1e>PATCH /users/:id/suspend</font>
BE -> RBAC : <font color=#1e1e1e>Check admin/super-user role</font>
RBAC -> BE : <font color=#1e1e1e>Allowed</font>
BE -> DB : <font color=#1e1e1e>Set user status to suspended/active</font>
BE -> Auth0S : <font color=#1e1e1e>Set blocked: true/false in Auth0</font>
